...
/**
 * Negotiates signaling for chatting with https://appr.tc "rooms". Uses the client<->server specifics of the apprtc
 * AppEngine webapp.
 *
 * <p>To use: create an instance of this object (registering a message handler) and
 * call connectToRoom().  Once room connection is established onConnectedToRoom() callback with room parameters is
 * invoked. Messages to other party (with local Ice candidates and answer SDP) can be sent after WebSocket connection is
 * established.
 */
    ...
    public void onWebSocketMessage(final String msg) {
        ...
        try {
            ...
            if (msgText.length() > 0) {
                ...
                Log.e("CANDIDATES ", json.toString());
