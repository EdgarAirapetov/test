 ...
 * passed in a constructor, otherwise exception will be thrown. All events are dispatched on the same thread.
 */
public class WebSocketChannelClient {
    ...
    /**
     * Callback interface for messages delivered on WebSocket. All events are dispatched from a looper executor thread.
     */
