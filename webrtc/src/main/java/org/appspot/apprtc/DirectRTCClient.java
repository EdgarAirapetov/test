...
/**
 * Implementation of AppRTCClient that uses direct TCP connection as the signaling channel. This eliminates the need for
 * an external server. This class does not support loopback connections.
 */
public class DirectRTCClient implements AppRTCClient, TCPChannelClient.TCPChannelEvents {
    ...
    /**
     * Connects to the room, roomId in connectionsParameters is required. roomId must be a valid IP address matching
     * IP_PATTERN.
     */
    @Override
