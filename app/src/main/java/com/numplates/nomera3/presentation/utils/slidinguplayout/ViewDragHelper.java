...
public class ViewDragHelper {
    ...
    private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel, int duration) {
        ...
        final int scrollDuration = duration == -1 ? computeSettleDuration(mCapturedView, dx, dy, xvel, yvel) : duration;
        mScroller.startScroll(startLeft, startTop, dx, dy, scrollDuration);
