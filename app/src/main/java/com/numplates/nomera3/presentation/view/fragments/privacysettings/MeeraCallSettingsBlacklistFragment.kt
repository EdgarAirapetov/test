...
class MeeraCallSettingsBlacklistFragment : MeeraBaseSettingsUserListFragment() {

    private val viewModel by viewModels<CallSettingsBlacklistViewModel> { App.component.getViewModelFactory() }
    ...
    override fun screenConfiguration() = MeeraBaseSettingsUserListConfiguration(
        screenTitle = getString(R.string.settings_who_call_me),
    ...
    override fun transitToAddUsersFragment() {
        findNavController().safeNavigate(R.id.action_meeraCallSettingsBlacklistFragment_to_meeraCallSettingsAddBlacklistFragment)
    }
