...
class MapSettingsAddBlackListFragment : SettingsUserSearchFragmentImpl(), IOnBackPressed {

    private val viewModel by viewModels<MapSettingsAddBlacklistViewModel>()
