...
class CircularProgressBar(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    var progressBarWidth: Float = resources.getDimension(R.dimen.cpb_default_stroke_width)
        set(value) {
            field = value.dpToPx()
    ...
    var backgroundProgressBarWidth: Float = resources.getDimension(R.dimen.cpb_default_background_stroke_width)
        set(value) {
            field = value.dpToPx()
