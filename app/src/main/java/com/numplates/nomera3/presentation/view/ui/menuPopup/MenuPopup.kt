package com.numplates.nomera3.presentation.view.ui.menuPopup
...
import com.numplates.nomera3.presentation.view.ui.bottomMenu.BottomItemView
...
@Deprecated("Transited to CORE. Should delete")
class MenuPopup(private val context: Context?) : PopupWindow(context) {
    ...
    fun show(anchorView: View? = null, gravity: Int = Gravity.CENTER, x: Int = 0, y: Int = 0) {
        context?.let {
            container.measure(WRAP_CONTENT, WRAP_CONTENT)
