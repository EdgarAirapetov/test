...
import com.numplates.nomera3.databinding.MeeraCellShimmerIncomingItemBinding

class MeeraCellIncomingShimmerAdapter
    : ListAdapter<String, MeeraCellIncomingShimmerAdapter.MeeraCellShimmerHolder>(DiffCallback()) {
    ...
    inner class MeeraCellShimmerHolder(
        val binding: MeeraCellShimmerIncomingItemBinding,
