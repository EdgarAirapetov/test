...
/**
 * Full copy of [DefaultItemAnimator] from [androidx.recyclerview:recyclerview] with deleted alpha animation.
 */
public class UnblinkingItemAnimator extends SimpleItemAnimator {
