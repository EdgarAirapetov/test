...
class MeeraPersonalMessageWhiteListFragment : MeeraBaseSettingsUserListFragment() {
    ...
    override fun screenConfiguration() = MeeraBaseSettingsUserListConfiguration(
            ...
            addUserItemTitle = getString(R.string.meera_settings_personal_message_subtitle),
    ...
    override fun transitToAddUsersFragment() {
        findNavController().safeNavigate(R.id.action_meeraPersonalMessageWhiteListFragment_to_meeraPersonalMessageAddWhiteListFragment)
    }
