 ...
 */
class BlacklistSettingsUsersFragment : BaseSettingsUserListFragment() {
    ...
    override fun screenConfiguration() = BaseSettingsUserListConfiguration(
        screenTitle = getString(R.string.settings_privacy_blocked),
        isShowAddUserItem = true,
        addUserItemTitle = getString(R.string.settings_privacy_block_profile),
        isShowDeleteAllItem = false,
    )
    ...
    override fun removeAllUsersFromList(userIds: List<Long>) {
        showDeleteAllConfirmationDialog { viewModel.deleteAllUsers() }
    }
