...
/**
 * Seekbar with longClickHandler.
 * @deprecated in the app. Use UiKitDetectorSeekBar instead in the uikit module.
 */
@Deprecated
public class DetectorSeekBar extends AppCompatSeekBar {
    ...
    private final LongClickChecker mLongClickChecker;
    private final ClickChecker mClickChecker;
    ...
    private static class LongClickChecker implements Runnable {
        ...
        private final WeakReference<DetectorSeekBar> mViewRef;
