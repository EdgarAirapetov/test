...
class MeeraSubscriberAdapter(
    ...
    inner class SubscriptionViewHolder(val binding: MeeraSubscribersUserItemBinding) :
        ...
        fun bind(
            ...
            binding.ivDeleteBtn.setThrottledClickListener {
                listener.invoke(MeeraSubscriptionAction.DeleteBtnClick(model))
            }
...
sealed class MeeraSubscriptionAction {
    class DeleteBtnClick(val model: SubscriptionAdapterModel) : MeeraSubscriptionAction()
    class ProfileAreaClick(val model: SubscriptionAdapterModel) : MeeraSubscriptionAction()
    class UnsubscribeBtnClick(val model: SubscriptionAdapterModel) : MeeraSubscriptionAction()
    class SubscribeBtnClick(val model: SubscriptionAdapterModel) : MeeraSubscriptionAction()
}

/**
 * This model is used by SubscriptionAdapter
 * if isSubscription == false => subscriber else subscription
 * */
