...
class MeeraCallSettingsWhitelistFragment : MeeraBaseSettingsUserListFragment() {

    private val viewModel by viewModels<CallSettingsWhitelistViewModel> { App.component.getViewModelFactory() }
    ...
    override fun transitToAddUsersFragment() {
        findNavController().safeNavigate(R.id.action_meeraCallSettingsWhitelistFragment_to_meeraCallSettingsAddWhitelistFragment)
    }
