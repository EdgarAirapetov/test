...
class MeeraMapSettingsBlacklistFragment : MeeraBaseSettingsUserListFragment(){
    ...
    override fun screenConfiguration() = MeeraBaseSettingsUserListConfiguration(
        screenTitle = getString(R.string.settings_privacy_map_permission),
    ...
    override fun transitToAddUsersFragment() {
        findNavController().safeNavigate(R.id.action_meeraMapSettingsBlacklistFragment_to_meeraMapSettingsAddBlackListFragment)
    }
