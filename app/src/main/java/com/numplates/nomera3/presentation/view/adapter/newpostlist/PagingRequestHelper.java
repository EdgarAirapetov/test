...
public class PagingRequestHelper {
    ...
    public static final class StatusReport {
        ...
        StatusReport(@NonNull Status initial, @NonNull Status before, @NonNull Status after, @NonNull Throwable[] errors) {
        ...
        public String toString() {
            return "StatusReport{" + "initial=" + initial + ", before=" + before + ", after=" + after + ", mErrors=" + Arrays.toString(mErrors) + '}';
        }
