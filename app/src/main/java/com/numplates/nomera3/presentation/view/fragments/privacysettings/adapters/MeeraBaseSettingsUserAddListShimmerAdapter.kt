...
import com.numplates.nomera3.databinding.MeeraMomentSettingsShimmerAddItemBinding

class MeeraBaseSettingsUserAddListShimmerAdapter
    : ListAdapter<String, MeeraBaseSettingsUserAddListShimmerAdapter.MeeraUserSettingsSearchShimmerHolder>(DiffCallback()) {
    ...
    inner class MeeraUserSettingsSearchShimmerHolder(
        val binding: MeeraMomentSettingsShimmerAddItemBinding,
