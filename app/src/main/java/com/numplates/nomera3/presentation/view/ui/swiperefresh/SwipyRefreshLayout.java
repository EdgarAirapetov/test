...
import com.numplates.nomera3.presentation.view.ui.TouchEventPasser;
...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    private TouchEventPasser touchEventPasser = null;
...
//    }
    ...
    public void setTouchDisabled(boolean isTouchDisabled) {
        this.isTouchDisabled = isTouchDisabled;
    }

    public void setTouchEventPasser(TouchEventPasser touchEventPasser) {
        this.touchEventPasser = touchEventPasser;
    }

    @Override
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (touchEventPasser != null) {
            touchEventPasser.onTouchPassed(ev);
            return false;
        } else {
