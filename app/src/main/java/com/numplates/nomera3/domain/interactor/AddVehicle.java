 ...
 * Created by abelov.
 */
public class AddVehicle extends UseCase<ResponseWrapper<VehicleResponse>> {
    ...
    public AddVehicle(ApiHiWay aboutRepository) {
    ...
    @Override
    protected Flowable<ResponseWrapper<VehicleResponse>> buildUseCaseObservable() {
        ...
        if(image != null && !image.isEmpty()) {
            ...
            return api.addVehicle(vehicleRequest.toRequestMap(), filePart);
        }
        return api.addVehicle(vehicleRequest);
    }
