...
class GetLocalUserSettingsUseCase @Inject constructor(private val repository: PrivacyUserSettingsRepository) {
    suspend fun invoke(): List<PrivacySettingModel> {
        return repository.getLocalUserPrivacySettings()
    }
}
