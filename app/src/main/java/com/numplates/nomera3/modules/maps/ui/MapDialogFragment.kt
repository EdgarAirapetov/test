...
import com.numplates.nomera3.databinding.DialogMapBinding
 ...
 */
abstract class MapDialogFragment : UiKitBottomSheetDialog<DialogMapBinding>() {
    ...
    override val inflateContent: (LayoutInflater, ViewGroup?, Boolean) -> DialogMapBinding
        get() = DialogMapBinding::inflate
