package com.numplates.nomera3.modules.peoples.ui.view
...
import com.numplates.nomera3.presentation.view.ui.FeedRecyclerVideoDataObserver
...
class MeeraPeopleRecyclerView @JvmOverloads constructor(
    context: Context,
    ...
    fun playVideo(isEndOfList: Boolean) {
        ...
        if (holder != null && holder is MeeraBloggerMediaContentListHolder) {
    ...
    private fun handleBloggerMediaContentList(
        holder: MeeraBloggerMediaContentListHolder,
        targetPosition: Int
    ) {
        if (firstVideo) {
            firstVideo = false
    ...
    private fun clearCacheForCurrentVideo() {
        MeeraAct.simpleCache?.removeResource(currentVideo)
    }
        ...
        addOnChildAttachStateChangeListener(object : OnChildAttachStateChangeListener {
            ...
            override fun onChildViewDetachedFromWindow(view: View) {
                ...
                if (viewHolderParent != null && viewHolderParent == view) {
                    val position = getChildAdapterPosition(view)
                    val holder: ViewHolder? = findViewHolderForAdapterPosition(position)
                    if (holder is MeeraBloggerMediaContentListHolder) {
                        val innerLayoutManager = (holder.getRecyclerView().layoutManager as LinearLayoutManager)
