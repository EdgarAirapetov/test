...
import com.numplates.nomera3.databinding.FragmentMapLayersBinding
 ...
 */
class MapLayersDialogFragment : BaseBottomSheetDialogFragment<FragmentMapLayersBinding>() {

    private val viewModel: MapLayersDialogViewModel by viewModels { App.component.getViewModelFactory() }
    private lateinit var locationContract: LocationContract
    ...
    private val tooltip: PopupWindow? by lazy {
        createTooltip(context, R.layout.tooltip_layers)
    }
    private var tooltipDismissJob: Job? = null

    override fun getTheme(): Int = R.style.LayersBottomSheetDialogTheme

    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> FragmentMapLayersBinding
        get() = FragmentMapLayersBinding::inflate
    ...
    private fun setupLocationContract() {
        ...
        locationContract = LocationDelegate(act, permissionDelegate, permissionListener)
    }
    ...
    private fun setupUi() {
        ...
        binding.layoutMapLayersMain.ukivMapLayersLocationDisabled.actionClickListener = {
            when {
                ...
                !locationContract.isLocationEnabled() -> locationContract.requestEnableLocation()
                else -> updateLocationAvailability()
            }
        }
