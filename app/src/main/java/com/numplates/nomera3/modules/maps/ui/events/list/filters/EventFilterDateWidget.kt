...
import com.numplates.nomera3.databinding.ViewEventFilterDateBinding
...
class EventFilterDateWidget @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = LayoutInflater.from(context)
        .inflate(R.layout.view_event_filter_date, this, true)
        .let(ViewEventFilterDateBinding::bind)
