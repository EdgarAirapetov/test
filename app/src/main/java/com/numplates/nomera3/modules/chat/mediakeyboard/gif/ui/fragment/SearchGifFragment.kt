...
class SearchGifFragment : BaseFragmentNew<FragmentMediakeyboardGifBinding>() {

    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> FragmentMediakeyboardGifBinding
        get() = FragmentMediakeyboardGifBinding::inflate
