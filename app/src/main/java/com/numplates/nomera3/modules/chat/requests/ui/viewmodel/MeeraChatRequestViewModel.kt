...
class MeeraChatRequestViewModel @Inject constructor(
    ...
    private fun initPaging() {
        ...
        val dataSource = chatRequestRoomsUseCase.invoke()
            .map { dialog ->
        ...
        roomsPagingList = LivePagedListBuilder(dataSource, pagedListConfig).build()
    }
