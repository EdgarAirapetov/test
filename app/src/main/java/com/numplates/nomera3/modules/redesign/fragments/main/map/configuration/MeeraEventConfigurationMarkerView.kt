...
import com.numplates.nomera3.databinding.MeeraViewEventConfigurationMarkerBinding
import com.numplates.nomera3.modules.maps.ui.events.model.EventConfigurationMarkerState

class MeeraEventConfigurationMarkerView @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = LayoutInflater.from(context)
        .inflate(R.layout.meera_view_event_configuration_marker, this, false)
        .apply(::addView)
        .let(MeeraViewEventConfigurationMarkerBinding::bind)
