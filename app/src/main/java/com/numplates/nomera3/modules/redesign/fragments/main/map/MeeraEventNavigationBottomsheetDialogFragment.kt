...
import com.numplates.nomera3.databinding.MeeraFragmentEventNavigationBottomsheetBinding
...
class MeeraEventNavigationBottomsheetDialogFragment :
    BaseBottomSheetDialogFragment<MeeraFragmentEventNavigationBottomsheetBinding>() {

    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> MeeraFragmentEventNavigationBottomsheetBinding
        get() = MeeraFragmentEventNavigationBottomsheetBinding::inflate
    ...
    companion object {
        ...
        ) = MeeraEventNavigationBottomsheetDialogFragment().apply {
            arguments = bundleOf(
