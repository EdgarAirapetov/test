...
class MapEventsUiMapperImpl @Inject constructor(
    context: Context,
    ...
    override fun mapEventConfigurationState(
        eventConfigurationUiMode: EventConfigurationUiMode,
        ...
        return when (eventConfigurationUiMode) {
            EventConfigurationUiMode.ONBOARDING -> EventConfigurationState.Onboarding(
                eventTypeItems = mapEventTypes(selectedType)
            )
            EventConfigurationUiMode.OPEN, EventConfigurationUiMode.HIDDEN -> {
            ...
            EventConfigurationUiMode.CLOSED -> EventConfigurationState.Closed
        }
    }
    ...
    override fun mapEventSnippetUiModel(
        ...
        return when {
            ...
            isPreloadedItem && dataFetchingState.error != null -> {
                ...
                val items = if (sortedPages.lastOrNull()?.size == EventsOnMap.EVENT_SNIPPET_PAGE_SIZE && dataFetchingState.loading) {
    ...
    companion object {
        private const val DATE_ITEMS_COUNT = 10
    }
}
