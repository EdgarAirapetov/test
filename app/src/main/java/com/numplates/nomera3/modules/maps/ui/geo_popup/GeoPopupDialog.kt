...
import com.numplates.nomera3.databinding.DialogGeoPopupBinding
...
class GeoPopupDialog(
    ...
    private val binding: DialogGeoPopupBinding = DialogGeoPopupBinding.inflate(layoutInflater)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.ibGeoPopupClose.setThrottledClickListener {
            bottomSheetCloseUtil.onCloseButtonPressed()
            dismiss()
        }
        binding.tvGeoPopupSkip.setThrottledClickListener {
            onGeoPopupAction(GeoPopupAction.Skip, origin)
            dismiss()
        }
        binding.tvGeoPopupEnable.setThrottledClickListener {
            onEnableGeoClicked()
