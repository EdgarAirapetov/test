...
const val MOMENT_PROGRESS_ANIMATION_FRAME_TIME_MS = 16L

interface MomentsContentPlayer {
...
class MomentsPlayerWrapper(
    private val momentPlayers: List<MomentsContentPlayer>,
    ...
    private var currentPlayer: MomentsContentPlayer? = null
    private var currentContentType: MomentContentType? = null
    private var currentTimelineState: MomentTimelineState? = null

    fun setupMomentContent(state: PositionViewMomentState.UpdateMoment) {
    ...
    fun setupErrorContent(errorState: PositionViewMomentState.UpdateMoment) {
