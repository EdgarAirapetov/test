...
import com.numplates.nomera3.databinding.MeeraViewEventFilterTypeBinding
...
class MeeraEventFilterTypeWidget @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = LayoutInflater.from(context)
        .inflate(R.layout.meera_view_event_filter_type, this, true)
        .let(MeeraViewEventFilterTypeBinding::bind)
