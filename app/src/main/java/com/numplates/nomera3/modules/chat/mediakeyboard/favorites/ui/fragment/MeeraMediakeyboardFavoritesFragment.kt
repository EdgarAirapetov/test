...
class MeeraMediakeyboardFavoritesFragment : MeeraBaseFragment(layout = R.layout.meera_mediakeyboard_favorites_fragment),
    BottomSheetSlideOffsetListener {

    private val binding by viewBinding(FragmentMediakeyboardFavoritesBinding::bind)
