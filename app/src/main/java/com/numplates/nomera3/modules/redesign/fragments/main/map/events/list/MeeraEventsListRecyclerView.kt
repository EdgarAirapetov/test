package com.numplates.nomera3.modules.redesign.fragments.main.map.events.list
...
import com.numplates.nomera3.modules.redesign.fragments.main.map.events.adapter.MeeraEventsListAdapter
import com.skydoves.baserecyclerviewadapter.RecyclerViewPaginator

class MeeraEventsListRecyclerView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        val eventItemSelectionListener = object : OnScrollListener() {
            override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
                ...
                val item = (adapter as MeeraEventsListAdapter).items?.getOrNull(itemPosition)
                if (item != null) {
        ...
        adapter = MeeraEventsListAdapter { itemActionListener.invoke(it) }
    ...
    fun setItems(items: List<EventsListItem>) {
        (adapter as MeeraEventsListAdapter).items = items
    }
