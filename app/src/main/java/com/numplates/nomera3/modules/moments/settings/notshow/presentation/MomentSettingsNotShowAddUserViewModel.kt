...
class MomentSettingsNotShowAddUserViewModel @Inject constructor(
    private val searchNotShowExclusionUseCase: MomentSettingsNotShowSearchMomentUseCase,
    private val addMomentNotShowExclusionUseCase: MomentSettingsNotShowAddExclusionUseCase,
    private val deleteMomentNotShowExclusionUseCase: MomentSettingsNotShowDeleteExclusionUseCase
    ...
    override suspend fun addUsersRequest(userIds: List<Long>) {
        addMomentNotShowExclusionUseCase.invoke(userIds)
    }
