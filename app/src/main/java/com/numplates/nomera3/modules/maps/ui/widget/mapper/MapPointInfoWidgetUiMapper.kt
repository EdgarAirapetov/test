package com.numplates.nomera3.modules.maps.ui.widget.mapper
...
class MapPointInfoWidgetUiMapper @Inject constructor(
...
//            topLevelHierarchyString
        ...
        if (zoom <= LEVEL_1_MAX_ZOOM) {
            ...
            return WidgetAddressStrings(primary = generatePrimaryAddress(), primaryString)
        }
