...
import com.numplates.nomera3.databinding.MeeraItemMomentUserBinding
import com.numplates.nomera3.modules.moments.show.presentation.data.MomentsIndicatorParams

class MeeraMomentsItemUserView @JvmOverloads constructor(
    context: Context,
    ...
    private val USER_CONTENT_CORNER_RADIUS = 12.dp
    private val DEFAULT_CONTENT_CORNER_RADIUS = 16.dp

    private val binding = MeeraItemMomentUserBinding.inflate(LayoutInflater.from(context), this, true)
    ...
    fun setAvatar(
        ...
        binding.vvMomentItemAvatar.setConfig(
            UserpicUiModel(
                storiesState = UserpicStoriesStateEnum.NO_STORIES,
                userAvatarUrl = avatarLink,
                size = UserpicSizeEnum.Size48
            )
        )
    }
