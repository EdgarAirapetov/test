 ...
 * @deprecated Deprecated in app module. Use UiKitCustomViewDragHelper instead
 */
@Deprecated
public class CustomViewDragHelper {
    ...
    // Customization start
    private boolean mDraggingUpRestricted = false;
    // Customization end
     ...
     * @return a new ViewDragHelper instance
     */
    public static CustomViewDragHelper create(@NonNull ViewGroup forParent, float sensitivity,
                                              @NonNull Callback cb) {
     ...
     * @param forParent Parent view to monitor
     */
    private CustomViewDragHelper(@NonNull Context context, @NonNull ViewGroup forParent,
                                 @NonNull Callback cb) {
        if (forParent == null) {
    ...
    // Customization start
    public void setDraggingUpRestricted(boolean restricted) {
        this.mDraggingUpRestricted = restricted;
    }
    // Customization end
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                for (int i = 0; i < pointerCount; i++) {
                    ...
                    // Customization start
                    if (mDraggingUpRestricted && dy < 0) break;
                    // Customization end
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                if (mDragState == STATE_DRAGGING) {
                    ...
                    // Customization start
                    if (mDraggingUpRestricted && y < mInitialMotionY[mActivePointerId]) break;
                    // Customization end
