...
abstract class MeeraBaseBottomSheetDialogFragment<T : ViewBinding> : BottomSheetDialogFragment()  {

    /**
     * Техдолг: https://nomera.atlassian.net/browse/BR-17556
     *
     * Необходимо во всех диалогах-шторках, которые наследуют класс [MeeraBaseBottomSheetDialogFragment]:
    ...
    protected var act: MeeraAct? = null
