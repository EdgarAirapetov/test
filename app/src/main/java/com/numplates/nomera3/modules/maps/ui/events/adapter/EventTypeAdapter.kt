...
import com.numplates.nomera3.databinding.ItemMapEventTypeBinding
...
class EventTypeAdapter(
...
) : ListAdapter<EventTypeItemUiModel, EventTypeAdapter.EventTypeViewHolder>(DiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EventTypeViewHolder {
        return EventTypeViewHolder(parent.inflate(R.layout.item_map_event_type))
    }
    ...
    class EventTypeViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(itemUiModel: EventTypeItemUiModel, onItemSelected: (EventTypeItemUiModel) -> Unit) {
            val binding = ItemMapEventTypeBinding.bind(itemView)
