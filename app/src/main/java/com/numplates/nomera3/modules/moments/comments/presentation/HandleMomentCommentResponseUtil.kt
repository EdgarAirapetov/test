 ...
 */
class HandleMomentCommentResponseUtil(
    ...
    fun handleCommentResponseSuccess(
        ...
        viewEvent.postValue(
            MomentsCommentViewEvent.NewCommentSuccess(
    ...
    fun handleCommentResponseError() {
        viewEvent.postValue(MomentsCommentViewEvent.OnScrollToBottom)
    }
