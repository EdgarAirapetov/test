...
class GetPrivateMessageBlackListWithCounterUseCase @Inject constructor(private val api: ApiMain) {

    suspend fun invoke(
        limit: Int,
        offset: Int
    ): ResponseWrapper<UserWrapperWithCounter<UserSimple>> {
        return api.getPrivateMessageBlacklistWithCounter(limit, offset)
    }
}
