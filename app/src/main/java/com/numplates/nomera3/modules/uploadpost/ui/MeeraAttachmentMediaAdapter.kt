...
import com.numplates.nomera3.databinding.MeeraItemMediaAttachmentBinding
import com.numplates.nomera3.modules.uploadpost.ui.data.UIAttachmentMediaModel

class MeeraAttachmentMediaAdapter(
    val imagePositioningListener: (imagePositioningInProcess: Boolean) -> Unit,
): RecyclerView.Adapter<MeeraAttachmentMediaAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = MeeraItemMediaAttachmentBinding.inflate(
    ...
    class ViewHolder(
        private val binding: MeeraItemMediaAttachmentBinding
