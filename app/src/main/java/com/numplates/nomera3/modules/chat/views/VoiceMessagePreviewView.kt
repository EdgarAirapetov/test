...
class VoiceMessagePreviewView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        View.inflate(context, R.layout.voice_message_preview_view, this)
    ...
    fun setStopState() {
        isPlaying = false
        setProgress(0)
        ivPlay?.setImageResource(R.drawable.ic_play_voice_preview)
    }
    ...
    private fun playControl() {
        ...
        ivPlay?.click {
            isPlaying = if (!isPlaying) {
                ...
                ivPlay?.setImageResource(R.drawable.ic_pause_voice_preview)
                true
            } else {
