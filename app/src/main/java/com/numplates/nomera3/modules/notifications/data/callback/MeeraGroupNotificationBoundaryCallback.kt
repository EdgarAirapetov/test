...
class MeeraGroupNotificationBoundaryCallback @Inject constructor(
    ...
    private fun fetchNotification(
        ...
        coroutineScope.launch {
            runCatching {
                ...
                Timber.d("fetchNotification: $dataMapped")
                dataMapped
                ...
                Timber.tag(this@MeeraGroupNotificationBoundaryCallback.simpleName).e(it)
