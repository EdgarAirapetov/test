...
public class NRangeBar extends View {
    ...
    public NRangeBar(Context context) {
        super(context);
    }

    public NRangeBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        rangeBarInit(context, attrs);
    }

    public NRangeBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnRangeBarChangeListener {
        ...
        void onRangeChangeListener(NRangeBar rangeBar, int leftPinIndex,
                                   int rightPinIndex, String leftPinValue, String rightPinValue);

        void onTouchStarted(NRangeBar rangeBar);

        void onTouchEnded(NRangeBar rangeBar);
    }
    ...
    public interface OnRangeBarTextListener {
        ...
        String getPinValue(NRangeBar rangeBar, int tickIndex);
    }
