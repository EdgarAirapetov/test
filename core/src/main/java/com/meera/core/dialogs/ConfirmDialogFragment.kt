...
import com.meera.core.databinding.FragmetConfirmDialogBinding
...
class ConfirmDialogBuilder() {
    ...
    fun setVertical(isVertical: Boolean): ConfirmDialogBuilder {
    ...
    fun setDialogCancelledListener(dialogCancelled: () -> Unit): ConfirmDialogBuilder{
